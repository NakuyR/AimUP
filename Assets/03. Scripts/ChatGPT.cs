...
namespace OpenAI
{
    public class ChatGPT : MonoBehaviour
    {
        ...
        private void LevelSet(){
            if (Fire.HitCount>40){
                TargetCtrl.speed = TargetCtrl.speed * 1.3f;
                StartGame.currentwidth = StartGame.currentwidth * 0.8f;
                StartGame.currentheight = StartGame.currentheight * 0.8f;
            }
            else{
                TargetCtrl.speed = TargetCtrl.speed * 0.7f;
                StartGame.currentwidth = StartGame.currentwidth * 1.2f;
                StartGame.currentheight = StartGame.currentheight * 1.2f;                
            }
